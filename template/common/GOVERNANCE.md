...
This document describes how decisions are made in {{PROJECT_NAME}} ({{PROJECT_SHORT}}).

## Model

{{PROJECT_SHORT}} follows a **BDFL-with-delegation** model: the Project Lead has final authority, and
...
- **Email** — `{{CONTACT_EMAIL}}` for anything that cannot be public.
